...
fprintf(inferenceFile, ...
    ...
    'subID', 'block', 'trial', 'targetImg', 'targetIdx', 'cueIdx','cue_string', 'congruent', 'respFrame', 'response', 'accuracy', 'RT', 'confResp', 'confRT', 'flickerDuration', 'noise1frames', 'signal1frames', 'noise2frames', 'coherence', 'catch_trial');