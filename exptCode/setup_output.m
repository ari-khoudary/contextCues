...
fprintf(inferenceFile, ...
    ...
    'subID', 'block', 'trial', 'targetImg', 'targetIdx', 'cue_rgb','cue_string', 'congruent', 'respFrame', 'response', 'accuracy', 'RT', 'confResp', 'confRT', 'flickerDuration', 'noise1frames', 'signal1frames', 'noise2frames', 'coherence');