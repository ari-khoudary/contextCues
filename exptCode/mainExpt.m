...
for block = 1:nBlocks
    ...
    pracString{1} = ['BORDER LEARNING INSTRUCTIONS: \n\n\n' ...
        'In this phase of the experiment, your main task is to learn the predictive relationship between 3 colored borders and the 2 scene images. \n\n' ...
    ...
    infString{1} = ['DECISION MAKING INSTRUCTIONS: \n\n\n'...
        ...
        'The flickering stream will be presented inside of the colored borders. \n' ...
        'The probability with which the borders predicted scene images during learning is the same probability with which the scene images dominate the flicker stream on each trial. \n\n'...
        'Again, your task is to determine which image dominated the flicker stream as quickly and accurately as possible.\n' ...
        'We encourage you to use the predictive relationships you just learned to help you perform better on the task.'];
