...
```{r plot calibration data, echo=F, fig.height=6, fig.width=6, fig.dpi=300}
...
```{r group inference summary, echo=F, fig.align='center', fig.dpi=300}
...
```{r group regressions: accuracy, echo=F, fig.dpi=300, fig.position='center', fig.width=8}
...
```{r group regressions: choice probability, echo=F}
