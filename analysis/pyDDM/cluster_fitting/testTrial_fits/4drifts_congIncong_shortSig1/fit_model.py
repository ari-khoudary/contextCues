...
def drift(t, trueCongruence, signal1_onset, noise2_onset, signal2_onset, signal1_duration,
                noise1_cong, noise1_neut, signal1_cong, signal1_incong, signal1_neut,
                noise2_cong, noise2_incong, noise2_neut, noise2_cong_shortS1, noise2_incong_shortS1, noise2_neut_shortS1,
                signal2_cong, signal2_incong, signal2_neut):
  ...
  if t >= noise2_onset and t < signal2_onset:
    if signal1_duration < 0.61:
      if trueCongruence == 'congruent':
        return noise2_cong_shortS1
      elif trueCongruence == 'incongruent':
        return -noise2_incong_shortS1
      else:
        return noise2_neut_shortS1
    else:
      if trueCongruence == 'congruent':
         return noise2_cong
      elif trueCongruence == 'incongruent':
...
try:
    ...
    model = pyddm.gddm(
        ...
        parameters={'B': (0.5, 12), 
                    ...
                    'noise2_cong_shortS1': (0, 10), 'noise2_incong_shortS1': (0,10), 'noise2_neut_shortS1': (0,10),
                    'signal2_cong': (0, 10), 'signal2_incong': (0, 10), 'signal2_neut': (0,10)},
        conditions = ['trueCongruence', 'signal1_onset', 'noise2_onset', 'signal2_onset', 'signal1_duration']
    )
