...
def drift(t, trueCongruence, signal1_onset, noise2_onset, signal2_onset, signal1_duration,
                noise1, noise1_50, signal1, signal1_50, noise2, noise2_50, noise2_shortS1, noise2_50_shortS1,
                signal2, signal2_50):
...
try:
    ...
    model = pyddm.gddm(
        ...
        parameters={'B': (0.5, 12), 
                    ...
                    'noise2_shortS1': (0, 10), 'noise2_50_shortS1': (0,10),
