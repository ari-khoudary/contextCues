...
try:
    ...
    model = pyddm.gddm(
        ...
        nondecision=0,
        parameters={'B': (0.5, 15), 
                    'noise1_cong': (-20, 200), 'noise1_neut': (-20,20),
                    'signal1_cong': (-20, 20), 'signal1_incong': (-20, 20), 'signal1_neut': (-20, 20),
                    'noise2_cong': (-20, 20), 'noise2_incong': (-20,20), 'noise2_neut': (-20,20),
                    'signal2_cong': (-20, 20), 'signal2_incong': (-20, 20), 'signal2_neut': (-20, 20)},
